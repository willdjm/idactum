...
<div className='flex flex-col justify-center items-center pt-5'>
    <nav className='navbar justify-between flex  justify-items-center w-full max-w-6xl'>
        ...
        <div className={click ? "nav-menu active flex flex-col text-center top-20 w-full left-0  bg-CinzaEscuro-500 text-white font-medium " : "nav-menu flex flex-col gap-5 p-3"}>
            <ul className={click ? 'flex flex-col ' : "nav-menu flex gap-5 font-medium"}>
                ...
                <li>
                    <Link
                        className='cursor-pointer rounded-full py-1 px-4 border md:border-black hover:bg-Verde-500 border-white'
            ...
            <ul className={click ? 'flex flex-col ' : "nav-menu flex justify-end gap-9 font-semibold overline decoration-2 decoration-Verde-500"}>
                <li>
