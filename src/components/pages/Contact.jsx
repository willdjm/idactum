...
<div className="flex flex-col justify-center items-center justify-items-center max-w-6xl">
  ...
  <form className='grid md:flex justify-center items-start w-full gap-3 md:gap-24' onSubmit={sendEmail}>
    <div className='flex flex-col flex-auto gap-3  w-auto'>
      ...
      <div className="mb-1.5">
        <input
          className=" border border-gray-600 text-gray600 text-base rounded-md focus:ring-green-500 focus:border-green-500 block w-full p-3 placeholder:font-semibold"
          id="phohe"
          type="tel"
    ...
    <div className='flex flex-col flex-auto gap-3  w-auto'>
      <div className=" items-end gap-2 justify-end justify-items-end flex flex-col"  >
        <textarea
          className=" border border-gray-600 text-gray-600 text-base rounded-md focus:ring-green-500 focus:border-green-500  w-full font-medium p-9 placeholder:font-semibold"
          id="message"
          rows="5"
        ...
        <button
          type="submit"
          className="text-white bg-green-500 hover:bg-green-400 focus:ring-4 focus:outline-none focus:ring-green-500 rounded-md text-base p-2 w-full md:w-44 text-center ">
          ENVIAR
        </button>
      </div>
    </div>
