...
<div id="DevelopersAndInvestors" className='flex flex-col justify-center items-center py-20'>
  <div className="flex flex-col justify-between justify-items-center max-w-6xl gap-20">
    <div className="flex items-end gap-8 justify-items-center justify-center max-w-6xl">
      ...
      <h1 className=' text-center  font-medium text-5xl'><span className='text-Verde-500'>i</span>ncorporadoras e <span className='text-Verde-500'>i</span>nvestidores</h1>
    </div>
    <div className="flex justify-items-center gap-10 justify-between max-w-6xl">
      ...
      <div className="flex flex-col max-w-xl py-10 px-10 pb-24 gap-5 bg-CinzaClaro-300 opacity-75 rounded-lg ">
    ...
    <ol className="flex justify-items-center items-center justify-center max-w-6xl">
      <li className="items-center     flex flex-col  relative  bottom-56 -left-5">
        <span className="flex text-base font-bold text-Verde-500 text-center items-center justify-center">
          Desde a prospecção
        </span>
        <span className="flex text-base text-center items-center justify-center">
    ...
    <div className="py-20 gap-20 flex items-center justify-center flex-col">
      <h1 className="font-semibold text-CinzaEscuro-500 text-2xl text-center items-center ">Veja como i360 é a solução ideal para sua atuação no mercado imobiliário</h1>
