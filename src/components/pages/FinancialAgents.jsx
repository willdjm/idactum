...
<div className="flex flex-col justify-between justify-items-center md:max-w-6xl">
    ...
    <div className="grid md:flex items-end justify-items-center justify-center top-0 md:pb-16 md:gap-10 ">
        <img className="flex items-center" src={logo} alt="" />
        <h1 className='flex items-center font-medium  text-gray-500 text-xl md:text-5xl'>agentes f<span className='text-gray-50 text-xl md:text-5xl'>i</span>nanceiros</h1>
    </div>
    <div className="grid md:flex justify-items-center justify-between ">
        <div className="flex flex-col md:max-w-lg">
            <h2 className="text-lg md:text-2xl font-bold md:pb-10">Tenha uma visão ampliada do mercado e fortaleça a rentabilidade dos investimentos imobiliários dos seus clientes.</h2>
        ...
        <div className="flex flex-col items-start justify-center max-w-xl  pt-10 p-10 gap-7 bg-white bg-opacity-30 rounded-3xl font-medium ">
    ...
    <div className='flex flex-col md:p-20'>
        <ol className="grid md:flex justify-items-center justify-center items-center max-w-6xl">
            ...
            <li className=" flex items-center text-white relative md:bottom-8 md:-left-52 z-30">
                <span className="flex p-2 md:p-7 text-base text-center items-center justify-center md:w-56 md:h-56 bg-green-500 border border-white rounded-full">
            ...
            <li className=" flex items-center text-white relative md:-bottom-0 md:left-0 z-30">
                <span className="flex p-2 md:p-10 text-base text-center items-center justify-center md:w-56 md:h-56 bg-green-500 border border-white rounded-full">
            ...
            <li className=" flex items-center text-white relative md:bottom-8 md:left-52 z-0">
                <span className="flex p-2 md:p-8 text-base text-center items-center justify-center md:w-56 md:h-56 bg-green-500 border border-white rounded-full">
    ...
    <div className='flex items-center justify-center p-20 pt-0'>
        <p className='text-center font-medium md:text-3xl text-white'>ACESSE DADOS ESTRATÉGICOS REAIS</p>
    </div>
    ...
    {/* Bloco5 */}
    <div className="w-52 md:w-full md:p-20">
        <Swiper className="md:w-3/4 md:max-w-3xl md:pb-20"
            slidesPerView={'auto'}
    ...
    {/* Bloco7 */}
    <div className="w-52 md:w-full md:p-20">
        <Swiper className="md:w-3/4 md:max-w-3xl"
            slidesPerView={'auto'}
            pagination={{ clickable: true }}
            navigation={true}
            grabCursor={true}
    ...
    <div className="flex items-end gap-5 justify-items-center justify-center max-w-6xl">
        <p className='font-bold text-gray-500 text-center text-3xl'>
            ...
            <br />com o <span className="md:text-5xl font-bold">at<span className="text-white md:text-5xl">i</span>vo imobiliário</span> dos seus clientes</p>
    </div>
