...
<div className='flex flex-col justify-center items-center bg-CinzaEscuro-500'>
    <div className='flex flex-col justify-between justify-items-center max-w-6xl'>
        ...
        <div id="OurSolutions" className="flex items-end justify-items-center justify-center p-16 gap-10 ">
            <h1 className=" text-white  text-center  font-semibold text-3xl">Multiplataforma de
                <span className="text-6xl">
                    <span className="md:text-Verde-500 text-Verde-500"> i</span>nteligência de dados</span> <br />para eficiência de investimentos através de ativos imobiliários.
            </h1>
        </div>
        {/* Bloco1 */}
        <div className='flex flex-col '>
            <ol className="flex justify-items-center justify-center items-center gap-14 p-20 text-white bg-CinzaEscuro-500 border-white max-w-6xl rounded-full">
                <img className='flex absolute z-10' src={seta} alt="" />
                <li className=" flex items-center  relative -bottom-5 left-0 z-20">
                    <span className="flex p-10 text-center items-center justify-center w-48 h-48 bg-CinzaEscuro-500 border border-whit rounded-full">
                ...
                <li className=" flex items-center  relative bottom-5 left-0 z-20">
                    <span className="flex p-8 text-center items-center justify-center w-48 h-48 bg-CinzaEscuro-500 border border-whit rounded-full">
        ...
        <div className='flex flex-col'>
            <div className="flex justify-items-center justify-center items-center max-w-6xl">
                <div className="bg-white text-CinzaEscuro-500 items-center p-10 gap-5 justify-center flex flex-col  justify-items-center  rounded-s-2xl ">
                    <img className=" items-center justify-center w-28" src={icon2} alt="" />
                    <h1 className="text-center font-medium  text-4xl "><span className="text-Verde-500 font-medium  text-4xl">i</span>ncorporadoras e <span className="text-Verde-500 font-medium  text-4xl">i</span>nvestidores</h1>
                    ...
                    <button className=" border  border-Verde-500 text-Verde-500  text-center p-2 w-44 text-base font-medium rounded-full ">Saiba mais</button>
                </div>
                <div className="bg-Verde-500  text-CinzaEscuro-500  items-center p-10 gap-5 justify-center flex flex-col justify-items-center  rounded-e-2xl ">
                    ...
                    <button className=" border  border-white text-Verde-500 bg-white   text-center p-2 w-44 text-base font-medium rounded-full">Saiba mais</button>
                </div>
            </div>
        </div>
        {/* Bloco4 */}
